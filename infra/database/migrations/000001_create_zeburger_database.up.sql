...
(
    "category_id"
) REFERENCES ze_burguer.categories
(
    id
)
    );
...
(
    "order_id"
) REFERENCES ze_burguer.orders
(
    id
),
    CONSTRAINT "FK_id_product" FOREIGN KEY
(
    "product_id"
) REFERENCES ze_burguer.products
(
    id
)
    );