...
INSERT INTO ze_burguer.products( "id", "category_id", "name_product", "price", "description")
VALUES (1, 1, 'x-salada', 10, 'hamburgão com salada');
INSERT INTO ze_burguer.products( "id", "category_id", "name_product", "price", "description")
VALUES (2, 2, 'suco de laranja', 2.50, 'gelado');
INSERT INTO ze_burguer.products( "id", "category_id", "name_product", "price", "description")
VALUES (3, 3, 'batata frita', 5, 'quente');
INSERT INTO ze_burguer.products( "id", "category_id", "name_product", "price", "description")
VALUES (4, 1, 'x-bacon', 10, 'hamburgão com bacon');
INSERT INTO ze_burguer.products( "id", "category_id", "name_product", "price", "description")
VALUES (5, 2, 'suco de limão', 3.50, 'gelado');
INSERT INTO ze_burguer.products( "id", "category_id", "name_product", "price", "description")
VALUES (6, 3, 'nuggets', 7, 'quente');